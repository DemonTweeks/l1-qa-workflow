...
- Clarified waterproofing: accept professionally applied sealing even if the exact 1+3+3 layer count is not clearly visible, and explicitly allow yellow heat shrink sleeves or equivalent encapsulation when the connector appears fully sealed.
